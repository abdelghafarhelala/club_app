class LastClubsModel {
  List<LastClubsData>? data;
  Links? links;
  Meta? meta;
  bool? success;
  String? message;
  ...
  LastClubsModel(
      {this.data, this.links, this.meta, this.success, this.message});

  LastClubsModel.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <LastClubsData>[];
      json['data'].forEach((v) {
        data!.add(new LastClubsData.fromJson(v));
      });
    }
...
class LastClubsData {
  ...
  LastClubsData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    area = json['area'];
